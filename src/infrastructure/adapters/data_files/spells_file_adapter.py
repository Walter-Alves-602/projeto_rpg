...
from src.infrastructure.repositories import ISpellRepository
from src.infrastructure.adapters.data_files import _SPELLS_DATA

class SpellFileAdapter(ISpellRepository):
    """
