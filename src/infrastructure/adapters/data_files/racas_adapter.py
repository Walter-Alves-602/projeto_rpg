...
_RACA_DATA = {
    "Anão": {
        ...
        "linguas": ["Comum", "Anão"],
        "deslocamento": 7.5,
        "habilidades_raciais": ["Visão no Escuro", "Resistência Anã", "Proficiência em Ferramentas Anãs"] # Exemplo
    },
    "Anão da Colina": {
        "atributos": {"constituicao": 2, "sabedoria": 1},
        "linguas": ["Comum", "Anão"],
        "deslocamento": 7.5,
        "habilidades_raciais": ["Visão no Escuro", "Resistência Anã", "Proficiência em Ferramentas Anãs", "Especialização em Pedra"] # Exemplo
    },
    "Anão da Montanha": {
        "atributos": {"forca": 2, "constituicao": 2},
        "linguas": ["Comum", "Anão"],
        "deslocamento": 7.5,
        "habilidades_raciais": ["Visão no Escuro", "Resistência Anã", "Proficiência em Ferramentas Anãs", "Treinamento em Combate Anão"] # Exemplo
    },
    ...
    "Elfo Alto": {
        ...
        "linguas": ["Comum", "Elfico"],
        "deslocamento": 9,
        "habilidades_raciais": ["Visão no Escuro", "Ancestralidade Feérica", "Transe", "Treinamento com Armas Élficas", "Magia Alta Élfica", "Escrita Élfica"]
    },
    "Elfo da Floresta": {
        "atributos": {"destreza": 2, "sabedoria": 1},
        "linguas": ["Comum", "Elfico"],
        "deslocamento": 9,
        "habilidades_raciais": ["Visão no Escuro", "Ancestralidade Feérica", "Transe", "Treinamento com Armas do Elfo da Floresta", "Pés Ligeiros", "Máscara da Natureza"]
    },
    "Elfo Negro": {
        "atributos": {"carisma": 1, "destreza": 2},
        "linguas": ["Comum", "Elfico", "Subterrâneo"],
        "deslocamento": 9,
        "habilidades_raciais": ["Visão no Escuro Superior", "Ancestralidade Feérica", "Transe", "Magia Drow", "Armamento Drow", "Sensibilidade à Luz Solar"]
    },
    ...
    "Halfling Robusto": {
        ...
        "linguas": ["Comum", "Halfling"],
        "deslocamento": 7.5,
        "habilidades_raciais": ["Coragem Halfling", "Agilidade Halfling", "Fortitude Robusta"]
    },
    ...
    "Draconato": {
        ...
        "deslocamento": 9,
        "habilidades_raciais": ["Ancestral Dracônica", "Resistência a Dano Dracônico", "Sopro Dracônico"]
    },
    ...
    "Gnomo da Rocha": {
        ...
        "linguas": ["Comum", "Gnômico"],
        "deslocamento": 7.5,
        "habilidades_raciais": ["Visão no Escuro", "Astúcia Gnômica", "Construtor de Gnomo da Rocha", "Engenhoso"]
    },

    "Meio-Elfo": {
        "atributos": {"carisma": 2, "destreza": 1}, # Destreza ou outro atributo é a escolha do jogador
        ...
        "habilidades_raciais": ["Visão no Escuro", "Ancestralidade Feérica", "Habilidades Versáteis", "Idiomas Adicionais"] # Habilidades Versáteis lida com as perícias e idiomas
    },
    ...
    "Meio-Orc": {
        ...
        "linguas": ["Comum", "Orc"],
        "deslocamento": 9,
        "habilidades_raciais": ["Visão no Escuro", "Ameaça Intimidadora", "Resistência Implacável", "Ataques Selvagens"]
    },
    ...
    "Tiefling": {
        ...
        "deslocamento": 9,
        "habilidades_raciais": ["Visão no Escuro", "Herança Infernal", "Resistência ao Fogo"]
    }
}
